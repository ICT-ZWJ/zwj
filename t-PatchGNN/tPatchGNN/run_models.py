...
from model.istsplm_tpatch import ISTS_tPatch
...
parser.add_argument('--model', type=str, default='ISTS_tPatch', help="Model name")
...
if __name__ == '__main__':
	...
	##################################################################
	if args.model == 'ISTS_tPatch':
		use_patch_ts = False
	else:
		use_patch_ts = True
		
	data_obj = parse_datasets(args, patch_ts=use_patch_ts)
	...
	elif args.model == 'ISTS_tPatch':
		model = ISTS_tPatch(args).to(args.device)
	else:
