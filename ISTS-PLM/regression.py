...
from models.istsplm_spd import istsplm_spd_forecast
...
parser.add_argument('--dist_alpha', type=float, default=1.0)
parser.add_argument('--dist_beta', type=float, default=1.0)
parser.add_argument('--spd_dim', type=int, default=4)
...
if __name__ == '__main__':
	...
	if(args.model == 'istsplm_spd_forecast'):
		model = istsplm_spd_forecast(args).to(args.device)
